...
export const updateAllFilters = createAsyncThunk('appCalendar/updateAllFilters', async (value, { dispatch }) => {
  if (value === true) {
    await dispatch(fetchEvents(['Personal', 'Business', 'Family', 'Holiday', 'Task']))
  } else {
...
export const appCalendarSlice = createSlice({
  ...
  initialState: {
    events: [],
    selectedEvent: {},
    selectedCalendars: ['Personal', 'Business', 'Family', 'Holiday', 'Task']
  },
  reducers: {
  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(updateAllFilters.fulfilled, (state, action) => {
        ...
        let selected = []
        if (value === true) {
          selected = ['Personal', 'Business', 'Family', 'Holiday', 'Task']
        } else {
          selected = []
        }
