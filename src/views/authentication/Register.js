    ...
    <div className='auth-wrapper auth-cover'>
      <Row className='auth-inner m-0'>
        <Link className='brand-logo' to='/' onClick={e => e.preventDefault()}>
          ...
          <h2 className='brand-text text-primary ms-1'>ProfiTrack</h2>
        </Link>
          ...
          <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
            ...
            <Form className='auth-register-form mt-2' onSubmit={e => e.preventDefault()}>
              <div className='mb-1'>
                ...
                <Input type='UserName' id='register-UserName' placeholder='john@example.com' autoFocus />
              </div>
              <div className='mb-1'>
                <Label className='form-label' for='register-email'>
                  Email
                </Label>
                <Input type='Email' id='register-Email' placeholder='john@example.com' autoFocus />
              </div>
              <div className='mb-1'>
